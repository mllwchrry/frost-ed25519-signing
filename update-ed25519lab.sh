...
git fetch https://github.com/DarkWindman/ed25519lab.git master
git subtree pull --prefix=python/ed25519lab https://github.com/DarkWindman/ed25519lab.git master --squash
