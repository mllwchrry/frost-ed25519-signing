...
git fetch https://github.com/BlockstreamResearch/ed25519lab.git master
git subtree pull --prefix=python/ed25519lab https://github.com/BlockstreamResearch/ed25519lab.git master --squash
