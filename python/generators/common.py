...
# vectors are reproducible. (They were originally chosen to give specific
# threshold-pubkey Y parities; parity no longer affects signing after the
# removal of the x-only/even-Y machinery.)
