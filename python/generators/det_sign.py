...
# Aggregate-other-nonce fault literals: each has one non-canonical (invalid)
# half so nonce aggregation rejects it as an invalid contribution.
...
class DetSignGroupBuilder:
    ...
    def add_error_tests(self) -> None:
        ...
        self._append_error(
            ...
            COMMON_MSGS[0],
            "invalid_contrib",
            "Aggregate of the other signers' nonces is invalid: first half is a non-canonical point encoding",
        ...
        self._append_error(
            ...
            COMMON_MSGS[0],
            "invalid_contrib",
            "Aggregate of the other signers' nonces is invalid: second half is a non-canonical encoding (y >= p)",
