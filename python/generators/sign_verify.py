...
class SignVerifyGroupBuilder:
    ...
    def _append_valid(
        ...
        assert partial_sig_verify(psig, pubnonces, signers, msg, ids.index(my_id))
    ...
    def _append_verify_error(
        ...
        expected_exc = ValueError if error == "value" else InvalidContributionError
        err = expect_exception(
            lambda: partial_sig_verify(psig, pubnonces, signers, msg, signer_index),
            expected_exc,
        )
    ...
    def _append_verify_fail(
        ...
        msg = COMMON_MSGS[0]
        signers = SignersContext(self.n, self.t, ids, pubshares, self.thresh_pk)
        assert not partial_sig_verify(psig, pubnonces, signers, msg, signer_index)
    ...
    def add_sign_error_tests(self) -> None:
        ...
        self._append_sign_error(
            ...
            COMMON_MSGS[0],
            "invalid_contrib",
            "Aggregate nonce is invalid: first half is a non-canonical point encoding",
        )
        self._append_sign_error(
            0,
            self.min_s,
        ...
        self._append_sign_error(
            ...
            COMMON_MSGS[0],
            "invalid_contrib",
            "Aggregate nonce is invalid: second half is a non-canonical encoding (y >= p)",
        )
